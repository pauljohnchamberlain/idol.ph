	...
	return (
		<section className='min-h-screen flex flex-col gap-y-32 p-14'>
			<div className='mt-10 flex flex-col items-center justify-center gap-2 font-semibold'>
				...
				<p className=' text-gray-400'>Simplest way to get paid for your Social Media influence </p>
			</div>
			...
			<div className='flex items-center gap-x-4 gap-y-2 flex-wrap justify-center'>
				<div className='relative'>
					<Image
						...
						src={'https://storage.googleapis.com/pai-images/599185e046af4cf2a028a46c394a5440.jpeg'}
						width={260}
						height={260}
					/>
					<div className='absolute bottom-0 bg-black/50 w-full flex flex-col items-start p-3'>
						<h4 className='bg-gradient-to-tr from-pink-50 to-blue-50 bg-clip-text text-transparent'>
							John Wick, <span className='text-gray-300 text-xs'>Science & Tech</span>
						</h4>
			...
			<div className='flex flex-col gap-y-3 items-center justify-center'>
				...
				<div className='flex items-center justify-center gap-x-5'>
					<Badge variant={'outline '} className='bg-gray-300 text-gray-600 text-3xl px-5 py-3 font-light'>
						Shopify
					</Badge>
			...
			<div className='w-3/4 mx-auto'>
				<Accordion type='single' collapsible className='w-full'>
					<AccordionItem value='item-1'>
						...
						<AccordionContent>
							Payments are made directly through our website. We use Dots to pay you out. Once you complete an order,
							you will be able to choose from over 5 methods including PayPal, CashApp or Venmo to receive your money.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem value='item-2'>
						<AccordionTrigger>Is my payment guaranteed?</AccordionTrigger>
						<AccordionContent>
							Yes, we collect the payment from the buyer and hold it until the order is complete. This ensures that both
							sides are protected during every transaction.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem value='item-3'>
						<AccordionTrigger>Can I decline orders?</AccordionTrigger>
						<AccordionContent>
							Yes, you are able to accept or decline an order. This gives you the freedom to only work with brands that
							align with you.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem value='item-4'>
						<AccordionTrigger>What platforms does Collabstr support?</AccordionTrigger>
						<AccordionContent>
							Currently you can list your services for Instagram, TikTok, YouTube, Threads
						</AccordionContent>
					</AccordionItem>
				</Accordion>
			</div>
