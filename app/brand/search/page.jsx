...
const generateDummyTalents = () => {
  ...
  return Array.from({ length: 30 }, (_, i) => ({
    ...
    image: `/brand/search/300x300.png`,
    ...
    const filtered = talents.filter(
      (talent) =>
        ...
        (filters.platforms.length === 0 ||
          filters.platforms.some((p) => talent.platforms.includes(p))) &&
        (filters.minFollowers === "" ||
          talent.followers >= parseInt(filters.minFollowers)) &&
        (filters.maxFollowers === "" ||
          talent.followers <= parseInt(filters.maxFollowers)) &&
        ...
        (filters.minHeight === "" ||
          talent.height >= parseInt(filters.minHeight)) &&
        (filters.maxHeight === "" ||
          talent.height <= parseInt(filters.maxHeight)) &&
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Total talent listings: {totalListings}
          </p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-[250px_1fr]">
        ...
        >
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFilters({ ...filters, ethnicity: value })
            }
          >
            <SelectTrigger>
          ...
          <div className="flex gap-2">
            <Input
              ...
              onChange={(e) =>
                setFilters({ ...filters, minHeight: e.target.value })
              }
            />
            <Input
              ...
              onChange={(e) =>
                setFilters({ ...filters, maxHeight: e.target.value })
              }
            />
          </div>
          <Select
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className={`h-4 w-4 ${i < talent.rating ? "text-yellow-400" : "text-gray-300"}`}
                        />
                      ))}
                    </div>
                    <span className="text-sm font-medium">
                      {talent.jobsBooked} Jobs booked
                    </span>
                  </div>
                </CardContent>
              </Card>
