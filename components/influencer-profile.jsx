...
const videos = [
  { title: "Introduction Video", thumbnail: "/placeholder.svg?text=Intro" },
  { title: "Dermaveen", thumbnail: "/placeholder.svg?text=Dermaveen" },
  { title: "Dsmile Campaign 2022", thumbnail: "/placeholder.svg?text=Dsmile" },
  {
    title: "Nude by Nature",
    thumbnail: "/placeholder.svg?text=Nude+by+Nature",
  },
  {
    title: "Brisbane City Council Campaign",
    thumbnail: "/placeholder.svg?text=Brisbane",
  },
  { title: "MCO Beauty 2023", thumbnail: "/placeholder.svg?text=MCO+Beauty" },
];
...
export function InfluencerProfileComponent() {
          ...
          <CardContent className="p-6">
            <div className="relative">
              <Avatar className="w-full h-auto aspect-square mb-4">
                <AvatarImage src="/placeholder.svg" alt="Aditi S" />
