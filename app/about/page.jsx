        ...
        <section className="py-20">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-xl">
              Welcome to the premier marketplace where influencers connect with
              brands and get paid for their creative content.
            </p>
          </motion.div>
        </section>
              ...
              {[
                {
                  ...
                  description:
                    "Showcase your niche, audience, and content style to attract the right brands.",
                },
                {
                  title: "Connect with Brands",
                  description:
                    "Browse opportunities and collaborate with brands that align with your values.",
                },
                {
                  title: "Get Paid",
                  description:
                    "Earn money for your creative content and grow your influence.",
                },
              ].map((step, index) => (
                <motion.div
                  key={index}
