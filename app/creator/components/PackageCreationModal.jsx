									...
									<div className='bg-blue-50 border border-blue-200 rounded-md p-4 flex items-start space-x-3'>
										...
										<div>
											...
											<p className='text-sm text-blue-600'>
												By keeping your package simple and targeted to one platform, you can refine your message and
												cater to specific brands. Start strong with a focused package, then impress the brand with your
												expertise.
											</p>
										</div>
									</div>
