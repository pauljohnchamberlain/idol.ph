    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-[#2D0A31] text-white">
      <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-between">
        <div>
          ...
          <div className="space-y-8 mt-8 md:mt-12">
            ...
            <p className="flex items-center">
              ...
              <span className="bg-[#3D1D41] px-4 py-2 rounded-full">
                +63 499 246 360
              </span>
            </p>
            <p className="flex items-center">
              <MapPin className="mr-4" /> Uptown Ritz, Fort Bonifacio, Taguig,
              Metro Manila
            </p>
          </div>
        </div>
        <div className="flex flex-wrap gap-4 mt-8 md:mt-0">
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full bg-[#3D1D41]"
          >
          ...
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full bg-[#B4177E]"
          >
      ...
      <div className="w-full md:w-1/2 bg-white text-[#2D0A31] p-8 md:p-12 md:rounded-l-3xl">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button
            type="submit"
            className="w-full bg-[#B4177E] text-white rounded-full py-6"
            disabled={isPending}
          >
            <Send className="mr-2" />
