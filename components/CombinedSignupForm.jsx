  ...
  return (
    <>
      ...
      <form
        ...
        className="grid grid-cols-1 gap-5 w-full max-w-md mx-auto my-10 px-4"
      >
        ...
        <button
          type="submit"
          className="w-full bg-primary text-white p-2 rounded-lg hover:bg-secondary"
        >
          Create Account
        </button>
        <p className="text-sm text-gray-500 text-center mt-4">
          By registering you confirm that you accept the Terms and Conditions
          and Privacy Policy
        </p>
      </form>
