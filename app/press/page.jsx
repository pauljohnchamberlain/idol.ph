			...
			<main className='container mx-auto px-4 py-12 space-y-16'>
				<section id='about'>
					...
					<p className='text-lg text-muted-foreground mb-4'>
						idol.ph is a pioneering social media marketplace that connects influencers, brands, and audiences in a
						seamless ecosystem. Our platform empowers content creators to monetize their influence while providing
						brands with authentic ways to reach engaged audiences.
					</p>
					<p className='text-lg text-muted-foreground'>
						Founded in 2023, idol.ph has quickly become the go-to platform for influencer marketing in Southeast Asia,
						...
						<CardContent className='flex flex-col md:flex-row justify-between items-start md:items-center p-6'>
							<div>
								...
								<p className='text-muted-foreground mb-2'>
									For all press-related questions and interview requests, please contact:
								</p>
								<p className='font-medium'>Maria Santos, Head of Public Relations</p>
							</div>
