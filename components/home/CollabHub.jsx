	...
	return (
		<div className='flex flex-col lg:flex-row items-center justify-center min-h-screen bg-blue-50 p-4 lg:p-8'>
			<div className='w-full lg:w-1/2 max-w-2xl mb-8 lg:mb-0 lg:mr-8'>
				...
				<h1 className='text-3xl lg:text-4xl font-bold mb-4'>Connect, Collab, Campaign in one place</h1>
				<p className='text-gray-600 mb-6'>
					Easily grow and manage your creator career. Access collaboration details and oversee campaigns from start to
					finish with features designed specifically for creators.
				</p>
			</div>
