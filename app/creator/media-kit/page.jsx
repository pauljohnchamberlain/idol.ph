	...
	return (
		<div className='container mx-auto px-4 py-8'>
			<div className='flex justify-between items-center mb-8'>
				...
				<Button className='bg-yellow-400 text-black hover:bg-yellow-500'>CREATE MEDIA KIT</Button>
			</div>
			...
			<p className='text-gray-600'>You haven't created a Media Kit yet. Create a Media Kit to start sharing.</p>
		</div>
	);
}
