  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <Card className="flex flex-col border-primary transition-shadow duration-300 hover:shadow-lg">
          <CardHeader>
          ...
          <CardContent className="flex-grow flex flex-col">
            ...
            <p className="text-3xl font-bold mb-2">
              {isAnnual ? "$790 USD" : "$79 USD"}
            </p>
            <p className="text-sm text-muted-foreground mb-6">
              {isAnnual ? "per year" : "per month"}
            </p>
            <Button className="w-full mb-6 mt-auto" variant="default">
              Go Plus Now
            </Button>
      ...
      <div className="mt-16 text-center">
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          <details className="bg-muted p-4 rounded-lg">
            ...
            <p className="mt-2">
              No, our services are provided on a month-to-month basis. You can
