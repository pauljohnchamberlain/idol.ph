		...
		<div>
			...
			<div className='head-center text-center p-4'>
				...
				<p className='p-2 pt-0 text-xl pb-5'>
					Discover influential personalities, execute marketing campaigns, and generate distinctive <br /> content for
			...
			<div className='influencers p-5 pb-12'>
				<h1 className='text-center p-4 text-5xl font-bold leading-snug'>Select your favorite Influencer</h1>
				<div className='instagram pb-16'>
					<h1 className='p-4 text-3xl font-sans font-bold leading-snug'>Instagram</h1>
					<div className='profiles px-8 grid grid-cols-3 gap-8'>
						<div className='profile h-[30vh] border rounded-lg'>
							...
							<div className='pro-desc p-4'>
								...
								<p className='text-md'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Molestias, debitis?</p>
				...
				<div className='youtube py-32 pb-56'>
					<h1 className='p-4 text-3xl font-sans font-bold leading-snug'>Youtube</h1>
					<div className='profiles px-8 grid grid-cols-3 gap-8'>
						<div className='profile h-[30vh] border rounded-lg'>
							<div className='pro-img'>
								<Image
